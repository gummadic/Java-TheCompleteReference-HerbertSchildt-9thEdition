package P07_MethodReferences;

// Use an intance method that takes two reference arguments
...
class HighTemp {
    ...
    // Return true if the invoking HighTemo object has the same
    // temperature as ht2.
...
public class InstanceMethObjectrefDemo {
    ...
    public static void main(String args[]) {
        ...
        // Create an array of HighTemp object.
        ...
        count = counter(weekDayHighs2,
                        HighTemp::sameTemp,
                        new HighTemp(12));
        System.out.println(count + " day had a high of 12.");
